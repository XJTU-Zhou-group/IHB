...
A1=[0.02 0.0037 0.0001 0.02 0.0008 0.0001]';
A2=[0 0 0 0 0 0]';
A3=[0.0036 0.0201 0.0001 0.0032 0.002 0.0001]';
A4=[0 0 0 0 0 0]';
A5=[0.0005 0.0008 0.0001 0.0001 0.0002 0.0001]';
A0=[A1;A2;A3;A4;A5];
S1=diff(S,t,1);
S2=diff(S,t,2);
%fm=inline(S'*m*S2);
...
s=xlswrite('C:\Users\Administrator\Desktop\IHB\comparison\IHB_1992_5dof\order_3\IHB_4P0_order3.xls',result);
toc