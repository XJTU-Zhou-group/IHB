...
m=[1];
k=[1];
%Cs=[cos(t) cos(3*t) cos(5*t) cos(7*t) cos(9*t) sin(t) sin(3*t) sin(5*t) sin(7*t) sin(9*t)];
Cs=[cos(t) sin(t)];
Cs1=diff(Cs,t,1);
S=[Cs];
...
sol = dde23(ddex1dez,[tau,tau],[0 1],[0, 30]);
tint=[0:0.01:30];
sint=deval(sol,tint);
...
s=xlswrite('C:\Users\sunpan\Desktop\IHB\comparison\IHB_delay_VDP\ddevdp.xls',dde);
t=xlswrite('C:\Users\sunpan\Desktop\IHB\comparison\IHB_delay_VDP\IHB_1.xls',IHB);
toc